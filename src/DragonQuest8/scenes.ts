...
const sceneDescs = [
    ...
    new SceneDesc("c03i09", "Argonia Castle: Levels 1-2"),
    new SceneDesc("c03i10", "Argonia Castle: Rear Levels 1-2"),
    new SceneDesc("c03i11", "Argonia Castle: Left Levels 3-4"),
    new SceneDesc("c03i13", "Argonia Castle: Right Levels 3-5"),
    ...
    new SceneDesc("s16i01", "Lord High Priest's Residence: Levels 1-2"),
    "Maella Abbey",
    ...
    new SceneDesc("m09i01", "Orkutsk: Dome A-F"),
    ...
    new SceneDesc("t01i03", "Tower of Alexandra: Levels 3-6"),
