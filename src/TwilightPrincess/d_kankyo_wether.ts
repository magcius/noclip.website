...
export class dKankyo__CommonTextures {
    ...
    constructor(globals: dGlobals) {
        ...
        /* const snowData = resCtrl.getObjectRes(ResType.Raw, `Always`, 0x56);
        this.snowTexture = loadRawTexture(globals, snowData, 32, 32, GX.TexFormat.I8, GX.WrapMode.CLAMP, GX.WrapMode.CLAMP); */
    }
