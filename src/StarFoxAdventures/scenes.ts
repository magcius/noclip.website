...
const sceneDescs = [
    ...
    new SFAMapDesc(8, 'loc8', 'ThornTail Hollow Cave'),
    new SFAMapDesc(9, 'loc9', 'Maze'),
    new SFAMapDesc(10, 'loc10', 'Ice Mountain'),
    ...
    new SFAMapDesc(16, 'loc16', 'CloudRunner Dungeon'),
    // new SFAMapDesc(17, 'loc17', 'Location'),
    new SFAMapDesc(18, 'loc18', 'Moon Mountain Pass'),
    new SFAMapDesc(19, 'loc19', 'Ice Mountain 2'),
    // new SFAMapDesc(20, 'loc20', 'Location 20'),
    new SFAMapDesc(21, 'loc21', 'Krazoa Shrine'),
    // new SFAMapDesc(22, 'loc22', 'Location'),
    new SFAMapDesc(23, 'loc23', 'Ice Mountain Race'),
    // new SFAMapDesc(24, 'loc24', 'Location'),
    // new SFAMapDesc(25, 'loc25', 'Location'),
    new SFAMapDesc(26, 'loc26', 'Test Map'),
    new SFAMapDesc(27, 'loc27', 'DarkIce Mines'),
    new SFAMapDesc(28, 'loc28', 'DarkIce Mines Boss'),
    new SFAMapDesc(29, 'loc29', 'Cape Claw'),
    // new SFAMapDesc(30, 'loc30', 'Location 30'),
    new SFAMapDesc(31, 'loc31', 'Blue Shrine Trial'),
    new SFAMapDesc(32, 'loc32', 'Green Shrine Trial'),
    new SFAMapDesc(33, 'loc33', 'Yellow Shrine Trial'),
    new SFAMapDesc(34, 'loc34', 'Hub Shrine?'),
    ...
    new SFAMapDesc(39, 'loc39', 'Blue Shrine Trial 2'),
    new SFAMapDesc(40, 'loc40', 'Green Shrine Arena'),
    // new SFAMapDesc(41, 'loc41', 'Location'),
    // new SFAMapDesc(42, 'loc42', 'Location'),
    new SFAMapDesc(43, 'loc43', 'CloudRunner Fortress Race'),
    new SFAMapDesc(44, 'loc44', 'Volcano Boss'),
    new SFAMapDesc(45, 'loc45', 'Ice Mountain Area'),
    // new SFAMapDesc(46, 'loc46', 'Location'),
    // new SFAMapDesc(47, 'loc47', 'Location'),
    new SFAMapDesc(48, 'loc48', 'Boss T-rex'),
    // new SFAMapDesc(49, 'loc49', 'Location'),
    new SFAMapDesc(50, 'loc50', 'Ocean Force Point'),
    new SFAMapDesc(51, 'loc51', 'Shop'),
    ...
    new SFAMapDesc(56, 'loc56', 'Volcano Link'),
    // new SFAMapDesc(57, 'loc57', 'Location'),
    new SFAMapDesc(58, 'loc58', 'Arwing 1'),
    new SFAMapDesc(59, 'loc59', 'Arwing 2'),
    new SFAMapDesc(60, 'loc60', 'Arwing 3'),
    new SFAMapDesc(61, 'loc61', 'Arwing 4'),
    new SFAMapDesc(62, 'loc62', 'Arwing 5'),
    ...
    new SFAMapDesc(67, 'loc67', 'Link'),
    new SFAMapDesc(68, 'loc68', 'Tunnel Race'),
    new SFAMapDesc(69, 'loc69', 'Dragon Link'),
    new SFAMapDesc(70, 'loc70', 'Volcano Plant'),
    new SFAMapDesc(71, 'loc71', 'Grassy Link'),
    new SFAMapDesc(72, 'loc72', 'Pit Link'),
    new SFAMapDesc(73, 'loc73', 'Temple Link'),
    new SFAMapDesc(74, 'loc74', 'Box Cage'),
