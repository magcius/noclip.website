...
const sceneDescs = [
    ...
    'Ancient Maps',
    new AncientMapDesc('ancient0', "Ancient Unknown Pit Room (DP?)", ANCIENT_DP_GAME_INFO, 0),
    new AncientMapDesc('ancient1', "Ancient Dragon Rock (DP?)", ANCIENT_DP_GAME_INFO, 1),
    new AncientMapDesc('ancient2', "Ancient Unknown Mine Room (DP?)", ANCIENT_DP_GAME_INFO, 2),
    new AncientMapDesc('ancient3', "Ancient ThornTail Hollow (Early SFA?)", ANCIENT_DP_GAME_INFO, 3),
    new AncientMapDesc('ancient4', "Ancient Northern Wastes (DP)", ANCIENT_DP_GAME_INFO, 4),
    new AncientMapDesc('ancient5', "Ancient Warlock Mountain (DP)", ANCIENT_DP_GAME_INFO, 5),
    new AncientMapDesc('ancient6', "Ancient Shop (DP?)", ANCIENT_DP_GAME_INFO, 6),
    new AncientMapDesc('ancient7', "Ancient CloudRunner Fortress (Early SFA)", ANCIENT_DP_GAME_INFO, 7),
    new AncientMapDesc('ancient8', "Ancient DarkIce Mines Exterior (DP)", ANCIENT_DP_GAME_INFO, 8),
    new AncientMapDesc('ancient9', "Ancient Ice Mountain Track 1 (DP)", ANCIENT_DP_GAME_INFO, 9),
    new AncientMapDesc('ancient10', "Ancient Ice Mountain Track 2 (DP)", ANCIENT_DP_GAME_INFO, 10),
    new AncientMapDesc('ancient11', "Ancient Ice Mountain Track 3 (DP)", ANCIENT_DP_GAME_INFO, 11),
    new AncientMapDesc('ancient12', "Ancient DarkIce Mines Interior (DP)", ANCIENT_DP_GAME_INFO, 12),
    new AncientMapDesc('ancient13', "Ancient DarkIce Mines Boss Room (DP)", ANCIENT_DP_GAME_INFO, 13),
    new AncientMapDesc('ancient14', "Ancient CloudRunner Fortress Race (Early SFA)", ANCIENT_DP_GAME_INFO, 14),
    new AncientMapDesc('ancient15', "Ancient Boss T-rex (DP?)", ANCIENT_DP_GAME_INFO, 15),
