...
import { fillMatrix4x3, fillMatrix4x2, fillVec3v } from "../gfx/helpers/UniformBufferHelpers.js";
...
import { clamp, computeModelMatrixR, setMatrixTranslation, transformVec3Mat4w1 } from "../MathHelpers.js";
...
export class LevelModelInstance {
    ...
    public prepareToRender(renderInstManager: GfxRenderInstManager, viewerInput: Viewer.ViewerRenderInput, modelMatrix: mat4, params: vec3, textureRemaps: GfxTexture[]): void {
        ...
        if (this.depthSort) {
            transformVec3Mat4w1(scratchVec3, scratchMatrix, this.model.center);
            template.sortKey = setSortKeyDepth(template.sortKey, -scratchVec3[2]);
        }
