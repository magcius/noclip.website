...
const sceneDescs = [
    ...
    new PortalSceneDesc("background1", "Test Chamber Menu"),
    new PortalSceneDesc("background2", "Victory Menu"),

    "Test Chambers",
    new PortalSceneDesc('testchmb_a_00', "Test Chamber 00-01"),
    new PortalSceneDesc('testchmb_a_01', "Test Chamber 02-03"),
    new PortalSceneDesc('testchmb_a_02', "Test Chamber 04-05"),
    new PortalSceneDesc('testchmb_a_03', "Test Chamber 06-07"),
    new PortalSceneDesc('testchmb_a_04', "Test Chamber 08"),
    new PortalSceneDesc('testchmb_a_05', "Test Chamber 09"),
    new PortalSceneDesc('testchmb_a_06', "Test Chamber 10"),
    new PortalSceneDesc('testchmb_a_07', "Test Chamber 11-12"),
    new PortalSceneDesc('testchmb_a_08', "Test Chamber 13"),
    new PortalSceneDesc('testchmb_a_09', "Test Chamber 14"),
    new PortalSceneDesc('testchmb_a_10', "Test Chamber 15"),
    new PortalSceneDesc('testchmb_a_11', "Test Chamber 16"),
    new PortalSceneDesc('testchmb_a_13', "Test Chamber 17"),
    new PortalSceneDesc('testchmb_a_14', "Test Chamber 18"),
    new PortalSceneDesc('testchmb_a_15', "Test Chamber 19 & Escape (Part 1)"),
    ...
    new PortalSceneDesc('testchmb_a_08_advanced', "Test Chamber 13 (Advanced)"),
    new PortalSceneDesc('testchmb_a_09_advanced', "Test Chamber 14 (Advanced)"),
    new PortalSceneDesc('testchmb_a_10_advanced', "Test Chamber 15 (Advanced)"),
    new PortalSceneDesc('testchmb_a_11_advanced', "Test Chamber 16 (Advanced)"),
    new PortalSceneDesc('testchmb_a_13_advanced', "Test Chamber 17 (Advanced)"),
    new PortalSceneDesc('testchmb_a_14_advanced', "Test Chamber 18 (Advanced)"),
];
