...
class StudioModelMeshData {
	public cleanVertexData: Float32Array | null = null;
    ...
    constructor(cache: GfxRenderCache, public materialNames: string[], private flags: StudioModelMeshDataFlags, staticVertexData: ArrayBufferLike, indexData: ArrayBufferLike, public vertexCount: number, public flexes: StudioFlex[]) {
        ...
        if (this.flags & StudioModelMeshDataFlags.HasDynamicPositionsNormals) {
			...
			// Keep a clean copy of the positions/normals if we're going to be flexing the mesh
			this.cleanVertexData = new Float32Array(staticVertexData.slice(0, 4 * dynamicWordCount));
	...
	public updateVertexData(device: GfxDevice, flexWeights?: Float32Array) {
		...
		device.uploadBufferData(this.dynamicVertexBuffer!, 0x00, new Uint8Array(flexedVertexData.buffer));
	}
