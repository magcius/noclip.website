...
export function fopAcM_create(globals: fGlobals, pcName: dProcName_e, parameters: number, pos: vec3 | null, roomNo: number, rot: vec3 | null, scale: vec3 | null, subtype: number, parentPcId: number, layer: number = -1): number | null {
