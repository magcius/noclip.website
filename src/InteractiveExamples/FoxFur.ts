...
import { TransparentBlack, colorNewCopy, colorLerp, colorNewFromRGBA, OpaqueBlack } from '../Color';
...
uniform sampler2D u_TexturePoreMask;
...
void main() {
    ...
    vec4 t_PoreMask = texture(SAMPLER_2D(u_TexturePoreMask), t_PoreTexCoord).rrrg;
...
const clearPass = makeAttachmentClearDescriptor(OpaqueBlack);
