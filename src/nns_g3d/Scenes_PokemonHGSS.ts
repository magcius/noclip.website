...
const sceneDescs = [
    ...
    new PokemonHGSSSceneDesc("332", "Sprout Tower 1F", false),
    new PokemonHGSSSceneDesc("333", "Sprout Tower 2F", false),
    new PokemonHGSSSceneDesc("334", "Sprout Tower 3F", false),
    new PokemonHGSSSceneDesc("335", "Sprout Tower 4F", false),
    new PokemonHGSSSceneDesc("336", "Sprout Tower 5F", false),
    new PokemonHGSSSceneDesc("337", "Sprout Tower 6F", false),
    new PokemonHGSSSceneDesc("338", "Sprout Tower 7F", false),
    new PokemonHGSSSceneDesc("339", "Sprout Tower 8F", false),
    new PokemonHGSSSceneDesc("341", "Sprout Tower 9F", false),
    new PokemonHGSSSceneDesc("340", "Sprout Tower Roof", false),
