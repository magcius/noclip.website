...
const sceneDescs = [
    ...
    new PokemonSoulSilverSceneDesc("366", "Vertical Checkpoint"),
    new PokemonSoulSilverSceneDesc("367", "???"),
    new PokemonSoulSilverSceneDesc("368", "???"),
    new PokemonSoulSilverSceneDesc("369", "Pokemon Center F2"),
    ...
    new PokemonSoulSilverSceneDesc("381", "Goldenrod Game Corner (JP Version)"),
    new PokemonSoulSilverSceneDesc("382", "Goldenrod Prize Corner"),
    ...
    new PokemonSoulSilverSceneDesc("396", "Mahogany Gym Room 1"),
    new PokemonSoulSilverSceneDesc("397", "Mahogany Gym Entrance"),
    new PokemonSoulSilverSceneDesc("398", "Fighting Dojo"),
    ...
    new PokemonSoulSilverSceneDesc("403", "Bill's Lab"),
