...
import { assert, assertExists, fallback, spliceBisectRight } from '../util.js';
import { DataFetcher, AbortedCallback } from '../DataFetcher.js';
import { MathConstants, computeModelMatrixSRT, clamp, projectionMatrixForCuboid } from '../MathHelpers.js';
...
import { JMapInfoIter, createCsvParser, JMapLinkInfo } from './JMapInfo.js';
import { LightDataHolder, LightDirector, LightAreaHolder } from './LightData.js';
import { DrawCameraType } from './DrawBuffer.js';
import { SceneNameObjListExecutor, DrawBufferType, DrawType, NameObjHolder, NameObj, GameBits, MovementType, CalcAnimType } from './NameObj.js';
import { getNameObjFactoryTableEntry, PlanetMapCreator, NameObjFactoryTableEntry } from './NameObjFactory.js';
import { ZoneAndLayer, LayerId, LiveActorGroupArray, getJMapInfoTrans, getJMapInfoRotate, ResourceHolder } from './LiveActor.js';
import { EffectSystem, ParticleResourceHolder } from './EffectSystem.js';
import { WaterAreaHolder, WaterAreaMgr, HazeCube, SwitchArea, MercatorTransformCube, DeathArea } from './MiscMap.js';
import { SensorHitChecker } from './HitSensor.js';
import { PlanetGravityManager } from './Gravity.js';
import { AreaObjMgr, AreaObj } from './AreaObj.js';
import { CollisionDirector } from './Collision.js';
import { ShadowControllerHolder } from './Shadow.js';
import { BaseMatrixFollowTargetHolder } from './Follow.js';
import { MessageArea, TalkDirector } from './Talk.js';
import { DemoDirector } from './Demo.js';
import { FurDrawManager } from './Fur.js';
import { GameSystemFontHolder, LayoutHolder } from './Layout.js';
import { getLayoutMessageDirect, MessageHolder } from './MessageData.js';
import { ImageEffectSystemHolder, BloomEffect, BloomEffectSimple, DepthOfFieldBlur, ImageEffectAreaMgr } from './ImageEffect.js';
import { ClipAreaDropHolder, ClipAreaHolder, FallOutFieldDraw } from './ClipArea.js';
import { StageSwitchContainer, SleepControllerHolder, initSyncSleepController, SwitchWatcherHolder } from './Switch.js';
import { AirBubbleHolder, WaterPlantDrawInit, TrapezeRopeDrawInit, SwingRopeGroup, ElectricRailHolder, PriorDrawAirHolder, CoinRotater, GalaxyNameSortTable, MiniatureGalaxyHolder, HeatHazeDirector, CoinHolder, SpinDriverPathDrawInit, GalaxyCometScreenFilter } from './Actors/MiscActor.js';
import { NoclipLegacyActorSpawner } from './Actors/LegacyActor.js';
import { StarPieceDirector, WaterPressureBulletHolder } from './Actors/MapObj.js';
import { MapPartsRailGuideHolder } from './MapParts.js';
import { LensFlareDirector, DrawSyncManager } from './Actors/LensFlare.js';
