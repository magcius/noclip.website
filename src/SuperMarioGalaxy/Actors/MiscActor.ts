...
import { Blue, Color, colorCopy, colorFromRGBA8, colorNewCopy, colorNewFromRGBA8, Green, Magenta, OpaqueBlack, Red, White, Yellow } from '../../Color.js';
import { buildEnvMtx, J3DModelInstance } from '../../Common/JSYSTEM/J3D/J3DGraphBase.js';
...
import { initFurPlanet } from '../Fur.js';
import { addBodyMessageSensorMapObj, addHitSensor, addHitSensorMapObj, addHitSensorEnemy, HitSensor, HitSensorType, addHitSensorPosMapObj, invalidateHitSensors, validateHitSensors, isSensorPressObj, setSensorRadius, sendArbitraryMsg, addHitSensorCallbackMapObj, addHitSensorCallbackMapObjSimple, addHitSensorEye, addHitSensorAtJoint, invalidateHitSensor } from '../HitSensor.js';
import { createCsvParser, getJMapInfoArg0, getJMapInfoArg1, getJMapInfoArg2, getJMapInfoArg3, getJMapInfoArg4, getJMapInfoArg5, getJMapInfoArg6, getJMapInfoArg7, getJMapInfoBool, getJMapInfoGroupId, JMapInfoIter } from '../JMapInfo.js';
import { LayoutActor } from '../Layout.js';
import { initLightCtrl } from '../LightData.js';
import { dynamicSpawnZoneAndLayer, isDead, isMsgTypeEnemyAttack, LiveActor, LiveActorGroup, makeMtxTRFromActor, MessageType, MsgSharedGroup, ZoneAndLayer } from '../LiveActor.js';
import { getObjectName, SceneObj, SceneObjHolder, SpecialTextureType } from '../Main.js';
import { getMapPartsArgMoveConditionType, MapPartsRailMover, MoveConditionType } from '../MapParts.js';
import { HazeCube, isInWater, WaterAreaHolder, WaterInfo } from '../MiscMap.js';
import { CalcAnimType, DrawBufferType, DrawType, GameBits, MovementType, NameObj, NameObjAdaptor } from '../NameObj.js';
import { isConnectedWithRail, RailRider } from '../RailRider.js';
import { addShadowVolumeCylinder, addShadowVolumeLine, getShadowProjectionLength, getShadowProjectionNormal, getShadowProjectionPos, initShadowController, initShadowFromCSV, initShadowSurfaceCircle, initShadowVolumeCylinder, initShadowVolumeFlatModel, initShadowVolumeSphere, isShadowProjected, onCalcShadow, onCalcShadowDropPrivateGravity, onCalcShadowDropPrivateGravityOneTime, onCalcShadowOneTime, onShadowVolumeCutDropLength, setShadowDropLength, setShadowDropPosition, setShadowDropPositionPtr, setShadowVolumeBoxSize, setShadowVolumeEndDropOffset } from '../Shadow.js';
import { calcNerveRate, isCrossedStep, isFirstStep, isGreaterEqualStep, isGreaterStep, isLessStep } from '../Spine.js';
import { isExistStageSwitchSleep } from '../Switch.js';
import { WorldmapPointInfo } from './LegacyActor.js';
import { addBrightObj, BrightObjBase, BrightObjCheckArg } from './LensFlare.js';
import { ItemBubble } from './MapObj.js';
...
class SeaGull extends LiveActor<SeaGullNrv> {
    ...
    protected override calcAndSetBaseMtx(sceneObjHolder: SceneObjHolder): void {
        setMatrixAxis(this.modelInstance!.modelMatrix, this.axisX, this.axisY, this.axisZ);
...
class CoconutTreeLeaf extends LiveActor {
    ...
    public update(scaleZ: number, scaleX: number, deltaTimeFrames: number): void {
        ...
        setMatrixAxis(this.jointMtx, this.axisX, this.axisY, this.axisZ);
    }
}
...
export class WaterPlantDrawInit extends NameObj {
    ...
    public loadTex(m: GXTextureMapping, plantType: number): void {
        if (plantType === 0)
...
export class Trapeze extends LiveActor {
    ...
    private updateStickMtx(): void {
        ...
        setMatrixAxis(this.stickMtx, point.axisX, point.axisY, point.axisZ);
...
export class Creeper extends LiveActor {
    ...
    public override control(sceneObjHolder: SceneObjHolder): void {
        ...
        setMatrixAxis(this.creeperFlowerMtx, headPoint.axisX, headPoint.axisY, headPoint.axisZ);
...
class OceanRingPipe extends LiveActor {
    ...
    private initPoints(sceneObjHolder: SceneObjHolder): vec3[] {
        ...
        const vertexAttributeDescriptors: GfxVertexAttributeDescriptor[] = [
            ...
            { location: getVertexInputLocation(VertexAttributeInput.TEX01), format: GfxFormat.F32_RG, bufferIndex: 0, bufferByteOffset: 6*0x04, },
        ];
...
export class Pole extends LiveActor {
    ...
    constructor(zoneAndLayer: ZoneAndLayer, sceneObjHolder: SceneObjHolder, infoIter: JMapInfoIter) {
        ...
        if (!this.noModel) {
            setMatrixAxis(this.bottomMtx!, this.axisX, this.axisY, this.axisZ);
    ...
    private updateTopPos(height: number): void {
        ...
        setMatrixAxis(this.topMtx!, this.axisX, this.axisY, this.axisZ);
