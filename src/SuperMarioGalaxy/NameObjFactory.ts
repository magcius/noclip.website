...
const ActorTable: NameObjFactoryTableEntry[] = [
    ...
    _("FlagRaceA",                      Flag),
    _("FlowerGroup",                    PlantGroup,                  makeRequestArchivesFunc(["Flower"])),
    _("FlowerBlueGroup",                PlantGroup,                  makeRequestArchivesFunc(["FlowerBlue"])),
    _("CutBushGroup",                   PlantGroup,                  makeRequestArchivesFunc(["CutBush"])),
