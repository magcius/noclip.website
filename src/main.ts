...
import * as Scenes_BanjoKazooie from './Content/bk/scenes';
import * as Scenes_Zelda_TwilightPrincess from './Content/ztp/ztp_scenes';
import * as Scenes_MarioKartDoubleDash from './Content/mkdd/mkdd_scenes';
import * as Scenes_Zelda_TheWindWaker from './Content/zww/zww_scenes';
import * as Scenes_SuperMarioSunshine from './Content/sms/sms_scenes';
import * as Scenes_Pikmin2 from './Content/pik2/pik2_scenes';
...
import * as Scenes_SuperMario64DS from './Content/sm64ds/scenes';
import * as Scenes_Zelda_OcarinaOfTime from './Content/zelview/scenes';
import * as Scenes_Zelda_OcarinaOfTime3D from './Content/oot3d/oot3d_scenes';
import * as Scenes_Zelda_MajorasMask3D from './Content/mm3d/mm3d_scenes';
import * as Scenes_LuigisMansion3D from './Content/lm3d/lm3d_scenes';
import * as Scenes_DarkSoulsCollision from './Content/dksiv/scenes';
import * as Scenes_MetroidPrime from './Content/mp3/scenes';
import * as Scenes_DonkeyKong64 from './Content/dk64/scenes';
import * as Scenes_DonkeyKongCountryReturns from './Content/dkcr/dkcr_scenes';
import * as Scenes_LuigisMansion from './Content/luigis_mansion/scenes';
import * as Scenes_PaperMario_TheThousandYearDoor from './Content/ttyd/Scenes_PaperMarioTTYD';
import * as Scenes_SuperPaperMario from './Content/spm/Scenes_SuperPaperMario';
import * as Scenes_MarioKartDS from './Content/mkds/Scenes_MarioKartDS';
import * as Scenes_NewSuperMarioBrosDS from './Content/nsmbds/nsmbds_scenes';
import * as Scenes_KingdomHearts from './Content/kh/scenes';
import * as Scenes_KingdomHeartsIIFinalMix from './Content/kh2fm/scenes';
import * as Scenes_Psychonauts from './Content/psychonauts/scenes';
import * as Scenes_DarkSouls from './Content/dks/scenes';
import * as Scenes_KatamariDamacy from './Content/katamari_damacy/scenes';
import * as Scenes_PaperMario64 from './Content/pm64/scenes';
import * as Scenes_Elebits from './Content/elb/Scenes_Elebits';
import * as Scenes_KirbysReturnToDreamLand from './Content/rtdl/Scenes_KirbysReturnToDreamLand';
import * as Scenes_Klonoa from './Content/klonoa/Scenes_Klonoa';
import * as Scenes_MarioAndSonicAtThe2012OlympicGames from './Content/MarioAndSonicAtTheOlympicGames2012/Scenes_MarioAndSonicAtTheOlympicGames2012';
import * as Scenes_MarioKartWii from './Content/mkwii/Scenes_MarioKartWii';
import * as Scenes_Okami from './Content/okami/Scenes_Okami';
import * as Scenes_SonicColors from './Content/sonic_colors/Scenes_SonicColors';
import * as Scenes_SuperSmashBrosBrawl from './Content/ssbb/Scenes_SuperSmashBrosBrawl';
import * as Scenes_Test from './Content/test/Scenes_Test';
import * as Scenes_WiiSportsResort from './Content/WiiSportsResort/Scenes_WiiSportsResort';
import * as Scenes_Zelda_SkywardSword from './Content/zss/Scenes_Zelda_SkywardSword';
import * as Scenes_InteractiveExamples from './Content/InteractiveExamples/Scenes';
import * as Scenes_Pilotwings64 from './Content/Pilotwings64/Scenes';
import * as Scenes_Fez from './Content/Fez/Scenes_Fez';
import * as Scenes_StarFoxAdventures from './Content/sfa/scenes';
import * as Scenes_SuperMarioOdyssey from './Content/smo/smo_scenes';
import * as Scenes_GTA from './GrandTheftAuto3/scenes';
import * as Scenes_SpongeBobBFBB from './Content/bfbb/scenes'
import * as Scenes_SuperSmashBrosMelee from './Content/SuperSmashBrosMelee/Scenes_SuperSmashBrosMelee';
import * as Scenes_PokemonSnap from './Content/snap/scenes';
import * as Scenes_MetroidPrimeHunters from './Content/mph/Scenes_MetroidPrimeHunters';
import * as Scenes_PokemonPlatinum from './Content/pkmnpl/Scenes_PokemonPlatinum';
import * as Scenes_PokemonSoulSilver from './Content/pkmnsslvr/Scenes_PokemonSoulSilver';
import * as Scenes_WiiUTransferTool from './Content/WiiUTransferTool/Scenes_WiiUTransferTool';
import * as Scenes_GoldenEye007 from './Content/GoldenEye007/Scenes_GoldenEye007';
import * as Scenes_BanjoTooie from './Content/bt/scenes';
import * as Scenes_SunshineWater from './Content/InteractiveExamples/SunshineWater';
import * as Scenes_HalfLife2 from './Content/HalfLife2/Scenes_HalfLife2';
import * as Scenes_TeamFortress2 from './Content/TeamFortress2/Scenes_TeamFortress2';
import * as Scenes_Portal from './Content/Portal/Scenes_Portal';
