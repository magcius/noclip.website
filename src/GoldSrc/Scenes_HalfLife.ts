...
const sceneDescs = [
    ...
    "Half-Life Anniversary Deathmatch",
    new HalfLifeSceneDesc('xen_dm'),
    new HalfLifeSceneDesc('contamination'),
    new HalfLifeSceneDesc('disposal'),
    new HalfLifeSceneDesc('doublecross'),
    new HalfLifeSceneDesc('pool_party'),
    new HalfLifeSceneDesc('rocket_frenzy'),
    new HalfLifeSceneDesc('rustmill'),
];
