...
function dKyr_thunder_move(envLight: dScnKy_env_light_c, cameraPos: vec3): void {
    ...
    } else if (envLight.thunderStateTimer === 1 || envLight.thunderStateTimer === 11) {
