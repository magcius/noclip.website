// d007_01.ts
// Illusory Dolhr Altitude 48m to Altitude 54m
...
export async function create_d007_01_gimmicks(layout: MapLayout, data_fetcher: DataFetcher, device: GfxDevice): Promise<gimmick[]>
{
    ...
    const elevator_to_ahead_point = get_point_from_group(layout.group_0, Elevator_toAhead);
    gimmicks.push
    (
    ...
    {
        const movable_floor_point = get_point_from_group(layout.group_0, Floor_A[i]);
        gimmicks.push
        (
            await create_gimmick
            (
