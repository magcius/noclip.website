...
export async function create_d010_01_gimmicks(layout: MapLayout, data_fetcher: DataFetcher, device: GfxDevice): Promise<gimmick[]>
{
    ...
    (
        ...
        (
            ...
            "TokyoMirageSessionsSharpFE/gimmick/d010/monolyth/skin/01/model.apak",
            "monolyth_01.bfres",
            data_fetcher,
            device
        )
    ...
    (
        ...
        (
            ...
            vec3.fromValues(0.0, 0.0, 0.0),
            vec3.fromValues(1.0, 1.0, 1.0),
            "TokyoMirageSessionsSharpFE/gimmick/d010/monolyth/skin/02/model.apak",
            "monolyth_02.bfres",
            data_fetcher,
            device
        )
    ...
    (
        ...
        (
            ...
            vec3.fromValues(0.0, 0.0, 0.0),
            vec3.fromValues(1.0, 1.0, 1.0),
            "TokyoMirageSessionsSharpFE/gimmick/d010/monolyth/skin/03/model.apak",
            "monolyth_03.bfres",
            data_fetcher,
            device
        )
