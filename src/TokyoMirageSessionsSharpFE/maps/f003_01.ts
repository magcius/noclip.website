...
export async function create_f003_01_gimmicks(layout: MapLayout, data_fetcher: DataFetcher, device: GfxDevice): Promise<gimmick[]>
{
    ...
    gimmicks.push
    (
        await create_actor("TokyoMirageSessionsSharpFE/Character/nonplayer/np100/skin/01", "np100_01.bfres", "fd_idle_00.anm", anna_position, anna_yaw, data_fetcher, device)
    );
