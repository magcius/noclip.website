...
export async function create_gimmicks(layout: MapLayout, data_fetcher: DataFetcher, device: GfxDevice): Promise<gimmick[]>
{
    ...
    const mannequinbig_01_fres = await get_fres_from_apak("TokyoMirageSessionsSharpFE/Character/gimmick/d003/mannequinbig/skin/01/model",
                                                            "mannequinbig_01.bfres", data_fetcher);
    const mannequinbig_02_fres = await get_fres_from_apak("TokyoMirageSessionsSharpFE/Character/gimmick/d003/mannequinbig/skin/02/model",
    ...
    (
        ...
        (
            ...
            "TokyoMirageSessionsSharpFE/Character/gimmick/d003/mannequin/skin/04/model",
            "mannequin_04.bfres",
            data_fetcher,
            device
        )
    ...
    (
        ...
        (
            ...
            vec3.fromValues(1.0, 1.0, 1.0),
            "TokyoMirageSessionsSharpFE/Character/gimmick/d003/mannequin/skin/01/model",
            "mannequin_01.bfres",
            data_fetcher,
            device
        )
    ...
    (
        ...
        (
            ...
            vec3.fromValues(1.0, 1.0, 1.0),
            "TokyoMirageSessionsSharpFE/Character/gimmick/d003/mannequin/skin/05/model",
            "mannequin_05.bfres",
            data_fetcher,
            device
        )
    ...
    (
        ...
        (
            ...
            vec3.fromValues(1.0, 1.0, 1.0),
            "TokyoMirageSessionsSharpFE/Character/gimmick/d003/mannequin/skin/02/model",
            "mannequin_02.bfres",
            data_fetcher,
            device
        )
    ...
    (
        ...
        (
            ...
            vec3.fromValues(1.0, 1.0, 1.0),
            "TokyoMirageSessionsSharpFE/Character/gimmick/d003/mannequin/skin/03/model",
            "mannequin_03.bfres",
            data_fetcher,
            device
        )
    ...
    (
        ...
        (
            ...
            vec3.fromValues(1.0, 1.0, 1.0),
            "TokyoMirageSessionsSharpFE/Character/gimmick/d003/mannequin/skin/12/model",
            "mannequin_12.bfres",
            data_fetcher,
            device
        )
    ...
    (
        ...
        (
            ...
            vec3.fromValues(1.0, 1.0, 1.0),
            "TokyoMirageSessionsSharpFE/Character/gimmick/d003/mannequin/skin/10/model",
            "mannequin_10.bfres",
            data_fetcher,
            device
        )
    ...
    (
        ...
        (
            ...
            vec3.fromValues(1.0, 1.0, 1.0),
            "TokyoMirageSessionsSharpFE/Character/gimmick/d003/mannequin/skin/09/model",
            "mannequin_09.bfres",
            data_fetcher,
            device
        )
    ...
    (
        ...
        (
            ...
            vec3.fromValues(1.0, 1.0, 1.0),
            "TokyoMirageSessionsSharpFE/Character/gimmick/d003/mannequin/skin/07/model",
            "mannequin_07.bfres",
            data_fetcher,
            device
        )
    ...
    (
        ...
        (
            ...
            vec3.fromValues(1.0, 1.0, 1.0),
            "TokyoMirageSessionsSharpFE/Character/gimmick/d003/mannequin/skin/13/model",
            "mannequin_13.bfres",
            data_fetcher,
            device
        )
    ...
    (
        ...
        (
            ...
            vec3.fromValues(1.0, 1.0, 1.0),
            "TokyoMirageSessionsSharpFE/Character/gimmick/d003/mannequinstand/skin/01/model",
    ...
    (
        ...
        (
            ...
            vec3.fromValues(1.0, 1.0, 1.0),
            "TokyoMirageSessionsSharpFE/Character/gimmick/d003/mannequinstand/skin/02/model",
