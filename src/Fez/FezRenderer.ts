...
void main() {
    ...
    vec4 t_DiffuseMapColor = texture(SAMPLER_2D(u_DiffuseTexture), t_DiffuseTexCoord.xy);
    ...
    vec4 t_ShadowMapColor = texture(SAMPLER_2D(u_ShadowTexture), t_ShadowTexCoord);
