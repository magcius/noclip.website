...
export interface CharPaths {
  nodes: Record<string, CharPathNode>;
  waypoints: CharPathWaypoint[];
}

export interface CharPathNode {
  pos: ReadonlyVec3;
  adjacent: string[];
}

export interface CharPathWaypoint {
  from: string;
  to: string;
  raycast: boolean;
  points: ReadonlyVec3[];
...
export const MICKEY_PATHS: CharPaths = {
  nodes: {
    a: {
...
export const CHAR_PROPERTIES: Record<string, CharProperties> = {
  // Mickey (Toontown Central)
  mk: {
    name: "Mickey",
  ...
  // Vampire Mickey (Toontown Central, Halloween)
  vmk: {
    name: "Mickey",
  ...
  // Witch Minnie (Minnie's Melodyland, Halloween)
  wmn: {
    name: "Minnie",
  ...
  // Super Goofy (Goofy Speedway, Halloween)
  sg: {
    name: "Goofy",
  ...
  // Western Pluto (The Brrrgh, Halloween)
  wp: {
    name: "Pluto",
  ...
  // Chip (Chip 'n Dale's Acorn Acres)
  ch: {
    name: "chip",
  ...
  // Dale (Chip 'n Dale's Acorn Acres)
  da: {
    name: "dale",
