...
// SceneLoader; the dest scene receives them via deserializeSaveState.
...
// Matches the renderer's deserializeSaveState arrival prefix:
//   [u8 hasArrival][i16 cellX][i16 cellY]
