...
const sceneDescs: Viewer.SceneDesc[] = [
    ...
    new DKCRSceneDesc(`FrontEnd.pak`,                                         "Map", "MWLD_Map"),
    ...
    new DKCRSceneDesc(`Worlds/W00_Trophy/L0X_Trophy_Blast.pak`,               "?-K Blast"),
    new DKCRSceneDesc(`Worlds/W00_Trophy/L0X_Trophy_Challenge.pak`,           "?-K Challenge"),
    new DKCRSceneDesc(`Worlds/W00_Trophy/L0X_Trophy_Collapse.pak`,            "?-K Collapse"),
    new DKCRSceneDesc(`Worlds/W00_Trophy/L0X_Trophy_Equalizer.pak`,           "?-K Equalizer"),
    new DKCRSceneDesc(`Worlds/W00_Trophy/L0X_Trophy_Ride.pak`,                "?-K Ride"),
    new DKCRSceneDesc(`Worlds/W00_Trophy/L0X_Trophy_Shift.pak`,               "?-K Shift"),
    new DKCRSceneDesc(`Worlds/W00_Trophy/L0X_Trophy_Spikes.pak`,              "?-K Spikes"),
    new DKCRSceneDesc(`Worlds/W00_Trophy/L0X_Trophy_Temple.pak`,              "?-K Temple"),
    new DKCRSceneDesc(`Worlds/W00_Trophy/L0X_Trophy_Vertical.pak`,            "?-K Vertical"),
];
