...
const sceneDescs = [
    "Cap Kingdom",
    new OdysseySceneDesc("Cap Kingdom", "CapWorldHomeStage"),
    ...
    "Cascade Kingdom",
    new OdysseySceneDesc("Cascade Kingdom", "WaterfallWorldHomeStage"),
    ...
    "Sand Kingdom",
    new OdysseySceneDesc("Sand Kingdom", "SandWorldHomeStage"),
    new OdysseySceneDesc("SandWorldMeganeExStage"),
    new OdysseySceneDesc("Sphinx room", "SandWorldSphinxExStage"),
    new OdysseySceneDesc("SandWorldUnderground000Stage"),
    new OdysseySceneDesc("SandWorldKillerExStage"),
    new OdysseySceneDesc("Crazy Cap", "SandWorldShopStage"),
    ...
    new OdysseySceneDesc("Slots", "SandWorldSlotStage"),
    ...
    "Wooded Kingdom",
    new OdysseySceneDesc("Wooded Kingdom", "ForestWorldHomeStage"),
    ...
    "Lake Kingdom",
    new OdysseySceneDesc("Lake Kingdom", "LakeWorldHomeStage"),
    new OdysseySceneDesc("Crazy Cap", "LakeWorldShopStage"),
    ...
    "Cloud Kingdom",
    new OdysseySceneDesc("Cloud Kingdom", "CloudWorldHomeStage"),
    new OdysseySceneDesc("2D Cube Sublevel", "Cube2DExStage"),
    new OdysseySceneDesc("FukuwaraiKuriboStage"),
    "Ruined Kingdom",
    new OdysseySceneDesc("Ruined Kingdom", "ClashWorldHomeStage"),
    new OdysseySceneDesc("Crazy Cap", "ClashWorldShopStage"),
    new OdysseySceneDesc("ImomuPoisonExStage"),
    new OdysseySceneDesc("JangoExStage"),
    "Metro Kingdom",
    new OdysseySceneDesc("Metro Kingdom", "CityWorldHomeStage"),
    new OdysseySceneDesc("Crazy Cap", "CityWorldShop01Stage"),
    ...
    new OdysseySceneDesc("Slots", "CityWorldSandSlotStage"),
    ...
    new OdysseySceneDesc("SMB 1-1 Sublevel", "Theater2DExStage"),
    new OdysseySceneDesc("DonsukeExStage"),
    new OdysseySceneDesc("Crowded Sublevel", "CityPeopleRoadStage"),
    new OdysseySceneDesc("T-Rex Chase Sublevel", "TrexBikeExStage"),
    "Seaside Kingdom",
    new OdysseySceneDesc("Seaside Kingdom", "SeaWorldHomeStage"),
    ...
    "Snow Kingdom",
    new OdysseySceneDesc("Snow Kingdom", "SnowWorldHomeStage"),
    ...
    new OdysseySceneDesc("Crazy Cap", "SnowWorldShopStage"),
    ...
    "Luncheon Kingdom",
    new OdysseySceneDesc("Luncheon Kingdom", "LavaWorldHomeStage"),
    ...
    new OdysseySceneDesc("Crazy Cap", "LavaWorldShopStage"),
    ...
    new OdysseySceneDesc("Chef Costume Sublevel", "LavaWorldCostumeStage"),
    "Dark side",
    new OdysseySceneDesc("Dark Side", "BossRaidWorldHomeStage"),
    new OdysseySceneDesc("BullRunExStage"),
    new OdysseySceneDesc("DotTowerExStage"),
    "Sky",
    new OdysseySceneDesc("SkyWorldHomeStage"),
    new OdysseySceneDesc("Crazy Cap", "SkyWorldShopStage"),
    ...
    "Moon Kingdom",
    new OdysseySceneDesc("Moon Kingdom", "MoonWorldHomeStage"),
    new OdysseySceneDesc("Wedding Hall", "MoonWorldWeddingRoomStage"),
    new OdysseySceneDesc("Crazy Cap", "MoonWorldShopRoom"),
    new OdysseySceneDesc("Sphinx Room", "MoonWorldSphinxRoom"),
    ...
    new OdysseySceneDesc("Other Wedding Hall", "MoonWorldWeddingRoom2Stage"),
    "Mushroom Kingdom",
    new OdysseySceneDesc("Mushroom Kingdom", "PeachWorldHomeStage"),
    new OdysseySceneDesc("Peach's Castle Interior", "PeachWorldCastleStage"),
    ...
    new OdysseySceneDesc("Crazy Cap", "PeachWorldShopStage"),
    new OdysseySceneDesc("SM64 Castle Courtyard Sublevel", "PeachWorldCostumeStage"),
