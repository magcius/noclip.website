...
const sceneDescs = [
    ...
    new OdysseySceneDesc("WanwanClashExStage", "Wanwan Clash Sublevel"),
    ...
    new OdysseySceneDesc("FukuwaraiKuriboStage", "Fukuwarai Kuribo Stage"),
    "Lost Kingdom",
    new OdysseySceneDesc("ClashWorldHomeStage", "Lost Kingdom"),
    new OdysseySceneDesc("ClashWorldShopStage", "Crazy Cap"),
    new OdysseySceneDesc("ImomuPoisonExStage", "Imomu Poison Sublevel"),
    ...
    new OdysseySceneDesc("PoleKillerExStage", "Pole Killer Sublevel"),
    new OdysseySceneDesc("BikeSteelExStage", "Bike Steel Sublevel"),
    new OdysseySceneDesc("CapRotatePackunExStage", "Cap Rotate Packun Sublevel"),
    new OdysseySceneDesc("ElectricWireExStage", "Electric Wire Sublevel"),
    ...
    new OdysseySceneDesc("SwingSteelExStage", "Swing Steel Sublevel"),
    new OdysseySceneDesc("PoleGrabCeilExStage", "Pole Grab Ceiling Sublevel"),
    new OdysseySceneDesc("Theater2DExStage", "SMB 1-1 Sublevel"),
    new OdysseySceneDesc("DonsukeExStage", "Donsuke Sublevel"),
    ...
    new OdysseySceneDesc("WaterValleyExStage", "Water Valley Sublevel"),
    new OdysseySceneDesc("SeaWorldSecretStage", "Seaside Secret Stage"),
    new OdysseySceneDesc("CloudExStage", "Cloud Sublevel"),
    new OdysseySceneDesc("SenobiTowerExStage", "Senobi Tower Sublevel"),
    new OdysseySceneDesc("ReflectBombExStage", "Bomb Reflect Sublevel"),
    new OdysseySceneDesc("TogezoRotateExStage", "Togezo Rotate Sublevel"),
    new OdysseySceneDesc("SeaWorldSneakingManStage", "Sneaking Man Stage"),
    new OdysseySceneDesc("SeaWorldUtsuboCaveStage", "Utsubo Cave Stage"),
    new OdysseySceneDesc("SeaWorldVibrationStage", "Vibration Stage"),
    "Snow Kingdom",
    new OdysseySceneDesc("SnowWorldHomeStage", "Snow Kingdom"),
    new OdysseySceneDesc("IceWaterBlockExStage", "Ice Water Block Sublevel"),
    new OdysseySceneDesc("SnowWorldTownStage", "Shiveria Town"),
    new OdysseySceneDesc("ByugoPuzzleExStage", "Byugo Puzzle Sublevel"),
    new OdysseySceneDesc("IceWaterDashExStage", "Ice Water Dash Sublevel"),
    new OdysseySceneDesc("KillerRailCollisionExStage", "Killer Rail Collision Sublevel"),
    new OdysseySceneDesc("SnowWorldCloudBonusExStage", "Cloud Bonus Sublevel"),
    ...
    new OdysseySceneDesc("IceWalkerExStage", "Ice Walker Sublevel"),
    ...
    new OdysseySceneDesc("LavaWorldUpDownExStage", "Up Down Sublevel"),
    new OdysseySceneDesc("LavaWorldBubbleLaneExStage", "Bubble Lane Sublevel"),
    new OdysseySceneDesc("LavaWorldFenceLiftExStage", "Fence Lift Sublevel"),
    new OdysseySceneDesc("LavaWorldClockExStage", "Clock Sublevel"),
    new OdysseySceneDesc("LavaWorldExcavationExStage", "Excavation Sublevel"),
    new OdysseySceneDesc("LavaWorldShopStage", "Crazy Cap"),
    new OdysseySceneDesc("DemoLavaWorldScenario1EndStage"),
    new OdysseySceneDesc("CapAppearLavaLiftExStage", "Cap Appear Lava Lift Sublevel"),
    new OdysseySceneDesc("ForkExStage", "Fork Sublevel"),
    new OdysseySceneDesc("GabuzouClockExStage", "Gabuzou Clock Sublevel"),
    ...
    new OdysseySceneDesc("TsukkunClimbExStage", "Tsukkun Climb Sublevel"),
    new OdysseySceneDesc("TsukkunRotateExStage", "Tsukkun Rotate Sublevel"),
    new OdysseySceneDesc("JizoSwitchExStage", "Jizo Switch Sublevel"),
    new OdysseySceneDesc("SkyWorldCloudBonusExStage", "Cloud Bonus Stage"),
    new OdysseySceneDesc("KaronWingTowerStage", "Karon Wing Tower Sublevel"),
    ...
    new OdysseySceneDesc("PeachWorldCostumeStage", "SM64 Castle Courtyard"),
    new OdysseySceneDesc("YoshiCloudExStage", "Yoshi Cloud Sublevel"),
    new OdysseySceneDesc("FukuwaraiMarioStage", "Fukuwarai Mario Stage"),
    new OdysseySceneDesc("DotHardExStage", "Dot Hard Sublevel"),
    ...
    new OdysseySceneDesc("PackunPoisonNoCapExStage", "Packun Poison Capless Sublevel"),
    new OdysseySceneDesc("KillerRoadNoCapExStage", "Killer Road Capless Sublevel"),
    new OdysseySceneDesc("BikeSteelNoCapExStage", "Bike Steel Capless Sublevel"),
    new OdysseySceneDesc("SenobiTowerYoshiExStage", "Senobi Tower Sublevel, with Yoshi"),
    new OdysseySceneDesc("ShootingCityYoshiExStage", "Tank Sublevel, with Yoshi"),
    new OdysseySceneDesc("LavaWorldUpDownYoshiExStage", "Up Down Sublevel, with Yoshi"),
