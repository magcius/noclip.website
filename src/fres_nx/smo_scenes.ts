...
const sceneDescs = [
    ...
    new OdysseySceneDesc("MoonWorldKoopa1Stage", "Final Bowser Capture Section"),
    "Mushroom Kingdom",
    ...
    "Duplicates",
    new OdysseySceneDesc("MoonWorldKoopa2Stage", "Final Bowser Capture Section Duplicate"),
