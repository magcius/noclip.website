...
const sceneDescs = [
    ...
    "Ruined Kingdom",
    new OdysseySceneDesc("ClashWorldHomeStage", "Ruined Kingdom"),
    ...
    new OdysseySceneDesc("LavaWorldCostumeStage", "Chef Costume Sublevel"),
    "Dark side",
    new OdysseySceneDesc("BossRaidWorldHomeStage", "Dark Side"),
    ...
    new OdysseySceneDesc("MoonWorldWeddingRoom2Stage", "Other Wedding Hall"),
    "Mushroom Kingdom",
