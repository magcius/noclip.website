...
const sceneDescs = [
    ...
    new PMTOKScene("field/W1G1_HouseA", "House 1"),
    new PMTOKScene("field/W1G1_HouseB", "House 2"),
    new PMTOKScene("field/W1G1_HouseC", "House 3"),
    new PMTOKScene("field/W1G1_HouseD", "House 4"),
    new PMTOKScene("field/W1G1_HouseE", "House 5"),
    new PMTOKScene("field/W1G1_HouseF", "House 6"),
    new PMTOKScene("field/W1G1_HouseG", "House 7"),
    ...
    new PMTOKScene("field/W7C1_KinopioHouse", "Sensor Lab"),
    ...
    new PMTOKScene("field/W1C4_BossArea", "Top of the Tower"),
    ...
    new PMTOKScene("field/W2C2_EntranceDragon", "Main Room"),
    new PMTOKScene("field/W2C2_CrabIntro", "Crab Room"),
    new PMTOKScene("field/W2C2_PuzzleEasy", "Slide Puzzle Room (Easy)"),
    new PMTOKScene("field/W2C2_PanelGetA", "Secret Room 1"),
    new PMTOKScene("field/W2C2_BoxMaze", "Box Maze Room"),
    new PMTOKScene("field/W2C2_CryDragon", "Water Wheel Room"),
    new PMTOKScene("field/W2C2_PuzzleHard", "Slide Puzzle Room (Hard)"),
    new PMTOKScene("field/W2C2_LoopWay", "Interstitial Room"),
    new PMTOKScene("field/W2C2_PanelGetB", "Secret Room 2"),
    new PMTOKScene("field/W2C2_BossArea", "Boss Room"),
    ...
    "Shogun Studios",
    new PMTOKScene("field/W2G2_CastlePark", "Shogun Studios"),
    new PMTOKScene("field/W2G2_HouseA", "House 1"),
    new PMTOKScene("field/W2G2_HouseE", "House 2"),
    new PMTOKScene("field/W2G2_HouseF", "House 3"),
    new PMTOKScene("field/W2G2_HouseH", "House 4"),
    new PMTOKScene("field/W2G2_LongHouseA", "Long House 1"),
    new PMTOKScene("field/W2G2_LongHouseB", "Long House 2"),
    new PMTOKScene("field/W2G2_HitTarget", "Shuriken Minigame"),
    ...
    new PMTOKScene("field/W2G2_TeaRoom", "Tea Building"),
    new PMTOKScene("battle/Btl_W2G2_CastleParkA", "Battle - Shogun Studios"),
    "Ninja Attraction",
    new PMTOKScene("field/W2C4_StartGoal", "Outside"),
    new PMTOKScene("field/W2C4_EntranceWay", "Entrance Room"),
    new PMTOKScene("field/W2C4_HangingScroll", "Hanging Scroll Room"),
    new PMTOKScene("field/W2C4_TatamiFlip", "Panel Flip Room"),
    ...
    new PMTOKScene("field/W2C4_SpearTrap", "Spear Trap Room"),
    new PMTOKScene("field/W2C4_CabinetStair", "File Cabinet Room"),
    new PMTOKScene("field/W2C4_PressWall", "Thwomp Wall Room"),
    new PMTOKScene("field/W2C4_GoalRoom", "Goal Room"),
    new PMTOKScene("battle/Btl_W2C4_NinjyayashikiA", "Battle - Ninja Attraction"),
    "Big Sho' Theater",
    new PMTOKScene("field/W2C5_EntranceGate", "Outside"),
    new PMTOKScene("field/W2C5_Lobby", "Lobby"),
    new PMTOKScene("field/W2C5_FirstTheater", "Stage 1"),
    new PMTOKScene("field/W2C5_SecondTheater", "Stage 2"),
    new PMTOKScene("field/W2C5_ThirdTheater", "Stage 3"),
    new PMTOKScene("field/W2C5_FourthTheater", "Stage 4"),
    ...
    "Other",
    new PMTOKScene("field/W7C1_KinokoRoomA", "Sensor Lab Office"),
    new PMTOKScene("field/W7C1_RadarTutorialA", "Sensor Lab Interior"),
