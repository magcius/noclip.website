...
const sceneDescs = [
    "Peach's Castle",
    new PMTOKScene("field/W0C1_CastleGate.bfres",               "Outside"),
    new PMTOKScene("field/W0C1_EntranceWay.bfres",              "Entrance Hall"),
    new PMTOKScene("field/W0C1_MainHall.bfres",                 "Main Hall"),
    new PMTOKScene("field/W0C1_HelpOlivia.bfres",               "Rescue Olivia (Dungeon)"),
    new PMTOKScene("field/W0C1_WallHole.bfres",                 "Main Room (Dungeon)"),
    new PMTOKScene("field/W0C1_FoldRoom.bfres",                 "Help Bowser (Dungeon)"),
    new PMTOKScene("field/W0C1_BasementWay.bfres",              "Exit Staircase (Dungeon)"),
    new PMTOKScene("field/W0C1_SpiralStair.bfres",              "Spiral Staircase (Dungeon)"),
    new PMTOKScene("field/W0C2_VolcanoCastle.bfres",            "Volcano"),
    ...
    new PMTOKScene("field/W1C1_BigStump.bfres",                 "Grandsappy"),
    ...
    new PMTOKScene("field/W1G1_ArtGallery.bfres",               "Art Gallery (Museum)"),
    new PMTOKScene("field/W1G1_KinopioGallery.bfres",           "Toad Gallery (Museum)"),
    new PMTOKScene("field/W1G1_CollectableGallery.bfres",       "Collectible Gallery (Museum)"),
    new PMTOKScene("field/W1G1_EnemyGallery.bfres",             "Enemy Gallery (Museum)"),
    new PMTOKScene("field/W1G1_SoundGallery.bfres",             "Sound Gallery (Museum)"),
    ...
    new PMTOKScene("field/W1G1_StoreRoom.bfres",                "Store Room (Red Brick Building)"),
    new PMTOKScene("field/W1G1_BackRoom.bfres",                 "Back Room (Red Brick Building)"),
