...
class PMTOKScene implements SceneDesc {
    ...
    public async createScene(device: GfxDevice, context: SceneContext): Promise<SceneGfx> {
        ...
        let mobjElf;
        if (!isBattle) {
            const mobjElfFile = await context.dataFetcher.fetchData(`${pathBase}/data/map/${this.id}/dispos_Mobj.elf`);
            ...
            for (const type of types) {
                ...
                const file = await context.dataFetcher.fetchData(`${pathBase}/mobj/${dir}/${name}.bfres`);
                ...
                if (!mobj) {
                    ...
                    for (const instance of mobjElf.instances) {
                        if (instance.type === fmdlData.fmdl.name.substring(5)) {
                            ...
                            sceneRenderer.modelRenderers.push(r);
                        }
                    }
                }
            }   
...
const sceneDescs = [
    "Peach's Castle",
    new PMTOKScene("field/W0C1_CastleGate.bfres",               "Outside the Castle"),
    new PMTOKScene("field/W0C1_EntranceWay.bfres",              "Entrance Hall"),
    new PMTOKScene("field/W0C1_MainHall.bfres",                 "Main Hall"),
    new PMTOKScene("field/W0C1_HelpOlivia.bfres",               "Dungeon (Rescue Olivia)"),
    new PMTOKScene("field/W0C1_WallHole.bfres",                 "Dungeon (Main)"),
    new PMTOKScene("field/W0C1_FoldRoom.bfres",                 "Dungeon (Help Bowser)"),
    new PMTOKScene("field/W0C1_BasementWay.bfres",              "Dungeon (Exit)"),
    new PMTOKScene("field/W0C1_SpiralStair.bfres",              "Spiral Staircase"),
    new PMTOKScene("field/W0C2_VolcanoCastle.bfres",            "Top of the Volcano"),
    new PMTOKScene("battle/Btl_W0C1_PeachcastleA.bfres",        "Battle - Peach's Castle"),
    "Whispering Woods",
    new PMTOKScene("field/W1C1_WakeUp.bfres",                   "Starting Area"),
    new PMTOKScene("field/W1C1_CastleView.bfres",               "Castle View"),
    new PMTOKScene("field/W1C1_LostForest.bfres",               "Whispering Woods (Main)"),
    new PMTOKScene("field/W1C1_BigStump.bfres",                 "Whispering Woods (Grandsappy)"),
    new PMTOKScene("field/W1C1_CampSite.bfres",                 "Camp Site"),
    new PMTOKScene("field/W1C1_LogHouse.bfres",                 "Log House"),
    new PMTOKScene("battle/Btl_W1C1_MountainA.bfres",           "Battle - Whispering Woods"),
    "Toad Town",
    ...
    new PMTOKScene("field/W1G1_ArtGallery.bfres",               "Museum (Art Gallery)"),
    new PMTOKScene("field/W1G1_KinopioGallery.bfres",           "Museum (Toad Gallery)"),
    new PMTOKScene("field/W1G1_CollectableGallery.bfres",       "Museum (Collectible Gallery)"),
    new PMTOKScene("field/W1G1_EnemyGallery.bfres",             "Museum (Enemy Gallery)"),
    new PMTOKScene("field/W1G1_SoundGallery.bfres",             "Museum (Sound Gallery)"),
    new PMTOKScene("field/W1G1_HouseA.bfres",                   "House A"),
    new PMTOKScene("field/W1G1_HouseB.bfres",                   "House B"),
    new PMTOKScene("field/W1G1_HouseC.bfres",                   "House C"),
    new PMTOKScene("field/W1G1_HouseD.bfres",                   "House D"),
    new PMTOKScene("field/W1G1_HouseE.bfres",                   "House E"),
    new PMTOKScene("field/W1G1_HouseF.bfres",                   "House F"),
    new PMTOKScene("field/W1G1_HouseG.bfres",                   "House G"),
    new PMTOKScene("field/W1G1_KartRoad.bfres",                 "Kart Road"), // no clue what this is
    new PMTOKScene("field/W1G1_KinopioHouse.bfres",             "Toad House"),
    new PMTOKScene("field/W1G1_DokanRoom.bfres",                "Pipe Room"),
    new PMTOKScene("field/W1G1_Shop.bfres",                     "Item Shop"),
    new PMTOKScene("field/W1G1_BattleLab.bfres",                "Battle Lab"),
    new PMTOKScene("field/W1G1_StoreRoom.bfres",                "Storage (Main Room)"),
    new PMTOKScene("field/W1G1_BackRoom.bfres",                 "Storage (Back Room)"),
    new PMTOKScene("field/W1G1_CastleGate.bfres",               "Peach's Castle Rubble"),
    new PMTOKScene("field/W1G3_GondolaLift.bfres",              "Gondola Lift"),
    new PMTOKScene("battle/Btl_W1G1_KinokoTownA.bfres",         "Battle - Toad Town"),
    new PMTOKScene("battle/Btl_W1G1_KinokoTownB.bfres",         "Battle - Toad Town (Underground)"),
    "Red Streamer",
    ...
    new PMTOKScene("field/W1G2_Hill.bfres",                     "Overlook Mountain"),
    new PMTOKScene("field/W1G3_Observatory.bfres",              "Overlook Tower"),
    "Overlook Tower",
    new PMTOKScene("field/W1C4_FirstFloor.bfres",               "1st Floor"),
    new PMTOKScene("field/W1C4_SecondFloor.bfres",              "2nd Floor"),
    new PMTOKScene("field/W1C4_ThirdFloor.bfres",               "3rd Floor"),
    new PMTOKScene("field/W1C4_FourthFloor.bfres",              "4th Floor"),
    new PMTOKScene("field/W1C4_Elevator.bfres",                 "Elevator"),
    new PMTOKScene("field/W1C4_BossArea.bfres",                 "Boss Area"),
    ...
    new PMTOKScene("battle/Btl_W1G2_HillA.bfres",               "Battle - Overlook Mountain"),
    ...
    new PMTOKScene("field/W6C1_Volcano.bfres",                  "Inside the Volcano"),
    new PMTOKScene("field/W6C2_CastleGate.bfres",               "Outside the Castle"),
    new PMTOKScene("field/W6C2_CollapsedWall.bfres",            "Castle Broken Wall"),
    "Origami Castle",
