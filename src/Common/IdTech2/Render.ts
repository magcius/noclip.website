...
layout(std140) uniform ub_SceneParams {
    ...
    vec4 u_Params[2];  // [0].x = time, [1].xyz = eye position
};
...
class View {
    ...
    public eyePos = new Float32Array(3);
    ...
    public finishSetup(): void {
        ...
        this.eyePos[0] = this.worldFromViewMatrix[12];
        this.eyePos[1] = this.worldFromViewMatrix[13];
        this.eyePos[2] = this.worldFromViewMatrix[14];
    }
...
export class BSPRenderer {
    ...
    public prepareToRender(renderInstManager: GfxRenderInstManager, view: View, worldLightingState: WorldLightingState): void {
        ...
        let offs = template.allocateUniformBuffer(GoldSrcProgram.ub_SceneParams, 16+4+4);
        ...
        offs += fillVec4(d, offs, view.eyePos[0], view.eyePos[1], view.eyePos[2]);
